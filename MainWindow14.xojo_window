...
Begin Window MainWindow14
   ...
   Placement       =   1
   Resizeable      =   True
   Title           =   "Word Crush 14x14 - High Score: 0"
   Visible         =   True
   Width           =   421
...
#tag WindowCode
	#tag Event
		Sub Close()
		  ...
		  f = SpecialFolder.Preferences.Child("wc14ud.txt")
		...
		Sub Open()
		  ...
		  if f.Exists then
		    ...
		    if t <> nil then
		      ...
		      self.Title = "Word Crush 14x14 - High Score: " + str(highscore)
		      t.Close
		    end
		  end
